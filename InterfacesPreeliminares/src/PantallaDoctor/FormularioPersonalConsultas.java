 ...
 * @author Elmer_GS
 */
public class FormularioPersonalConsultas extends javax.swing.JFrame {

    /**
     * Creates new form PantallaPrincipal
     */
    public FormularioPersonalConsultas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Consultas Personal");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RFC", "Nombre Completo", "Telefono", "Fraccionamiento", "Calle", "Num Interior", "Num Exterior", "Codigo Postal", "Correo", "Hora Entrada", "Hora Salida", "Sueldo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioPersonalConsultas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioPersonalConsultas().setVisible(true);
            }
        });
    }
