 ...
 * @author Elmer_GS
 */
public class FormularioPaceinteBaja extends javax.swing.JFrame {

    /**
     * Creates new form PantallaPrincipal
     */
    public FormularioPaceinteBaja() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioPaceinteBaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioPaceinteBaja().setVisible(true);
            }
        });
    }
