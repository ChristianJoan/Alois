 ...
 * @author Elmer_GS
 */
public class FormularioEncargadosConsultas extends javax.swing.JFrame {
    ...
    String SQL;
    ConexionDB conector;
    public FormularioEncargadosConsultas() {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Consultas Encargado");
        ...
        jTableConsulta.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jTableConsulta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null, null, null}
            },
            new String [] {
                "RFC", "Nombre Completo", "Telefono", "Fraccionamiento", "Calle", "Num Interior", "Num Exterior", "Codigo Postal", "Correo"
            }
        ));
        jTableConsulta.setCellSelectionEnabled(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) this.jTableConsulta.getModel();
        ...
        try {
            while (rs.next()) {
                ...
                model.addRow(fila);
                this.jTableConsulta.setModel(model);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioEncargadosConsultas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioEncargadosConsultas().setVisible(true);
            }
        });
    }
